        ...
        else
        {
            ...
            else
            {
                if (plugin.al.isAdminImpostor(playerSender))
                {
                    ...
                    if (!plugin.arl.isArchitect(playerSender))
                    {
                        Architect architect = null;
                        for (Architect loopArchitect : plugin.arl.getAllArchitects().values())
                        {
                            if (loopArchitect.getName().equalsIgnoreCase(playerSender.getName()))
                            {
                        ...
                        if (architect != null)
                        {
                            if (playerSender != null)
                            {
                                architect.setName(playerSender.getName());
                                architect.addIp(Ips.getIp(playerSender));
                            }
