...
@CommandParameters(description = "Overlord - control this server in-game", usage = "/<command>", aliases = "ov")
public class Command_overlord extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (args[0].equals("addme"))
        {
            ...
            msg("Added yourself to the superadmin list.");
            return true;
        }
        ...
        if (args[0].equals("removeme"))
        {
            ...
            msg("Removed yourself from the superadmin list.");
            return true;
        }
