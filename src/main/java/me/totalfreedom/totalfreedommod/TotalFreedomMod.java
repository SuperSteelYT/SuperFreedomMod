...
import me.totalfreedom.totalfreedommod.architect.ArchitectList;
import me.totalfreedom.totalfreedommod.architect.ArchitectWorldRestrictions;
...
public class TotalFreedomMod extends AeroPlugin<TotalFreedomMod>
{
    ...
    public ArchitectWorldRestrictions mbwr;
    ...
    public void enable()
    {
        ...
        mbwr = services.registerService(ArchitectWorldRestrictions.class);
