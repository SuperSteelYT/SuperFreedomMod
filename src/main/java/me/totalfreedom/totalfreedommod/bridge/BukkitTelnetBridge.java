...
public class BukkitTelnetBridge extends FreedomService
{
    ...
    public void onTelnetRequestDataTags(TelnetRequestDataTagsEvent event)
    {
        ...
        while (it.hasNext())
        {
            ...
            boolean isTelnetSuperAdmin = false;
            ...
            if (admin != null)
            {
                ...
                isAdmin = active;
                isSeniorAdmin = active && admin.getRank() == Rank.SENIOR;
                isTelnetSuperAdmin = active && (isSeniorAdmin || admin.getRank() == Rank.SUPER);
            }

            playerTags.put("tfm.admin.isAdmin", isAdmin);
            playerTags.put("tfm.admin.isTelnetSuperAdmin", isTelnetSuperAdmin);
