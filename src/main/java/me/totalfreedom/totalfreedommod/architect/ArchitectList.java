...
public class ArchitectList extends FreedomService
{
    ...
    public ArchitectList(TotalFreedomMod plugin)
    {
        super(plugin);
    ...
    public void load()
    {
        ...
        for (String key : config.getKeys(false))
        {
            ...
            {
                FLog.warning("Could not load architect: " + key + ". Missing details!");
                continue;
            }
    ...
    public boolean addArchitect(Architect architect)
    {
        if (!architect.isValid())
        {
            FLog.warning("Could not add architect: " + architect.getConfigKey() + " architect is missing details!");
            return false;
        }

        final String key = architect.getConfigKey();

        // Store architect, update views
        architects.put(key, architect);
        updateTables();
