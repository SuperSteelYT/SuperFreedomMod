...
public enum ConfigEntry
{
    ...
    //
    SERVER_MOTD_COLORFUL(Boolean.class, "server.motd.colorful"),
    SERVER_NAME(String.class, "server.name"),
    SERVER_ADDRESS(String.class, "server.address"),
    SERVER_MOTD_LINE_ONE(String.class, "server.motd.line_one"),
    SERVER_MOTD_LINE_TWO(String.class, "server.motd.line_two"),
    SERVER_MOTD_IP_BAN(String.class, "server.motd.ip_ban"),
    SERVER_MOTD_ADMIN_ONLY(String.class, "server.motd.admin_only"),
    SERVER_MOTD_LOCKDOWN(String.class, "server.motd.lockdown"),
    SERVER_MOTD_WHITELIST(String.class, "server.motd.whitelist"),
    SERVER_MOTD_SERVER_FULL(String.class, "server.motd.server_full"),
    ...
    //
    OP_ON_JOIN(Boolean.class, "misc.op_on_join"),
    BLOCKED_FREE_HOSTS(List.class, "misc.blocked_free_hosts"),
    //
    ADMININFO_LINE_ONE(String.class, "admininfo.line_one"),
    ADMININFO_LINE_TWO(String.class, "admininfo.line_two"),
    ADMININFO_LINE_THREE(String.class, "admininfo.line_three"),
    ADMININFO_LINE_FOUR(String.class, "admininfo.line_four"),
    //
    ...
    //
    THREATPANEL_ACCESS_LIST(List.class, "threatpanel_access_list");
    //
